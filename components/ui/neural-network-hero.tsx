...
const fragmentShader = `
  ...
  void main() {
    ...
    // Remap purple hue to green hue
    gl_FragColor = vec4(color.g * 0.25, color.r * 0.9 + color.b * 0.15, color.b * 0.2, 1.0);
  }
`;
...
export function NeuralNetworkBackground() {
    ...
    return (
        <div ref={canvasRef} className="bg-black fixed inset-0 z-0 w-full h-full" aria-hidden>
            <Canvas
                orthographic
